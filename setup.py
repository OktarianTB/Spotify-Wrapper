...
setup(
  ...
  version = 'v0.3-alpha',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/OktarianTB/easy_spotify/archive/v0.3-alpha.tar.gz',
