...
setup(
  name = 'simple_spotify',         # How you named your package folder (MyLib)
  packages = ['simple_spotify'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/OktarianTB/simple-spotify/archive/v0.1-alpha.tar.gz',
  keywords = ['SPOTIFY', 'SIMPLE', 'WEB API'],   # Keywords that define your package best
  install_requires=[
          'requests',
          'json',
      ],
